 ...
 */
const CACHE_NAME = 'iraka-field-v2.31.0'; // v2.31.0: [A]図面テキストのグリフ結合（1文字ずつの図面でも縮尺/勾配/軒の出を復元）＝伝法邸で 1/60・勾配[2,4]寸・軒の出[250,300,600] を自動検出。軒の出ラベルに妻/けらば追加 / v2.30.0: [A]確認カード / v2.29.0: [A]立面から勾配・軒の出
const ASSETS = [
  './portal.html',
  './index.html',
  './completion.html',
